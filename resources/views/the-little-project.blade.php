...
<html lang="en">
  <head>
    ...
    <title>The Little Project</title>
<!-- google font -->
  ...
  <body>
    ...
    <section class="team-section">
      <div class="container">
        <br />
        <center>
          <h2 class="heading-team-section">The Little Project</h2>
        </center>
        <br />
            ...
            <div class="carousel-item active">
              <div class="row">
                ...
                <div class="col-md-6 team-member-content">
                  ...
                  <p>
                   <em> <strong>We've got you covered with all the art supplies!<br />
                    The kid should have been exposed to school environment.<br />
                    This session is exclusively for children;<br />
                    parents are not permitted in the classroom.</strong></em>
                  </p>
    ...
    <div class="card-container-3-card-list-second">
      <div class="card">
        ...
        <ul>
          <li>Learn about colour, shape,drawing,painting
            and vocabulary.
            </li>
          <li>Improve fine motor skills
            and pincer grip.
            </li>
      ...
      <div class="card">
        ...
        <ul>
          <li>
            A fun experience in a relaxed
            environment.
            
          </li>
          <li>
            Take the art works made in
            each session.
                      </li>
        </ul>
      </div>
      <div class="card">
        ...
        <span>Tuesday & Thursday
        </span>
        <span>Evening Batch-3:00pm to 4:00pm
        </span>
        <h3>Weekday Batch</h3>

        <span>Saturday & Sunday
        </span>
        <span>Morning Batch-11:30 am to 12:30pm</span>
      </div>
    </div>
    ...
    <div class="card-row-event-pricelist-first">
      <div class="card large-card">
        <h4>We do not provide Trial classes or Compensation classes!</h4>
      ...
      <div class="card-small">
        ...
        <form action="{{route('theLittleProject.payment.information.show')}}" method="post">
            @csrf
            <input type="hidden" value="4899" name="price"/>
            <button class="btn-primary" type="submit"><center> <b>4,899 ₹</b></button>
        </form>
       <!-- <center> <b>4,899₹</b></center> -->
      </div>
      <div class="card-small">
        <div class="plans-label-tag">
          <h6>ADVANCED</h6>
        ...
        <form action="{{route('theLittleProject.payment.information.show')}}" method="post">
            ...
            <button class="btn-primary" type="submit"><center> <b>12,899 ₹</b></button>
        </form>
      ...
      <div class="card-small">
        ...
        <form action="{{route('theLittleProject.payment.information.show')}}" method="post">
            ...
            <button class="btn-primary" type="submit"><center> <b>23,899₹</b></button>
        </form>
       <!-- <center> <b>23,899₹ </b></center> -->
      </div>

      <h3>
        Ready to dive in to this Program? Checkout our Subscription Planand click below
