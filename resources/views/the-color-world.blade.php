  ...
  <body>
    ...
    <section class="team-section">
      <div class="container">
        ...
        <center>
          <h2 class="heading-team-section">The Color World</h2>
        </center>
    ...
    <div class="card-container-3-card-list-second">
      <div class="card">
        ...
        <ul>
          <li>Learn all about colours that thereis tolearn.</li>
          <li>Explorea wide range of mediums.</li>
          <li>Learn different painting and collage techniques.</li>
        </ul>
      </div>
      <div class="card">
        ...
        <ul>
          <li>
            5 student-made art works to take home at the end of each class.
          </li>
      ...
      <div class="card">
        ...
        <span>Wednesday </span>
        <span>Evening Batch-4:00pm to5:00pm </span>
        <h3>Weekday Batch</h3>

        <span>Saturday</span>
        <span>Evening Batch-4:30pm to 5:30pm</span>
      </div>
    </div>
    ...
    <form action="{{route('theColorWorld.payment.information.show')}}" method="post">
        @csrf
        <input type="hidden" value="3899" name="price"/>
        <center><button class="enroll-now" type="submit">Entroll Now</button></center>
    </form>
