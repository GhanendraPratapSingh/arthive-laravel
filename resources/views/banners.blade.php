...
<body>
  ...
  <div class="swiper-container laptop" id="slider">
    <div class="swiper-wrapper">
      <div class="swiper-slide"><img alt="sliderimage1" id="image1" src="assets/img/bg/3.png" /></div>
      <div class="swiper-slide"><img alt="sliderimage1" id="image1" src="assets/img/bg/4.png" /></div>
  ...
  <div class="swiper-container mobile" id="slider">
    <div class="swiper-wrapper">
      <div class="swiper-slide"><img alt="sliderimage1" id="image1" src="assets/img/bg/1.png" /></div>
      <div class="swiper-slide"><img alt="sliderimage1" id="image1" src="assets/img/bg/2.png" /></div>
